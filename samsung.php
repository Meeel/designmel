	...
	<main class="main main--demo-6">
		...
		<div class="grid-container-works">
			<div class="item item-1">
				<a href="work" class="link-back"><img src="assets/images/iconos/arrow-back.svg" alt="back" class="arrow-back"></a>
			...
			<div class="item item-2 animated fadeInRight delay--5">
				<button class="scrolldown btn-down"><img src="assets/images/iconos/arrow-down.svg" alt="Arrow"></button>
				...
				<img src="assets/images/work/samsung-portada.jpg" alt="Restaurante" class="img-header-works">
			</div>
		</div>
		<div class="item-fw">
			<div>
		...
		<div class="item-fw-2">
			<div class="container-fw2">
				<video width="100%" controls loop>
					<source src="assets/videos/samsung/note-8-spen.mp4" type="video/mp4">
					<source src="assets/videos/samsung/note-8-spen.ogv" type="video/ogg">
					<source src="assets/videos/samsung/note-8-spen.webm" type="video/webm">
				</video>
				<img src="assets/images/work/samsung-full.jpg" alt="Samsung">
			</div>
		</div>
	</main>
	<!--Btn Up-->
