<div class="content content--demo-6">
	...
	<div class="global-menu">
		<div class="global-menu__wrap">
			<img src="assets/images/header/hero.png" alt="Flower" class="global-menu__item img-menu-global">
			<a class="global-menu__item global-menu__item--demo-6" href="work">Proyectos</a>
			<a class="global-menu__item global-menu__item--demo-6" href="contacto">Contacto</a>
		</div>
		<div class="global-menu__item socialMedia">
			<p class="txt-menu-links"><a href="https://www.behance.net/MelissaAlmanza" target="_blank" class="link-menu-sm">Behance</a> <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span><a href="https://www.instagram.com/designmeel/"  target="_blank" class="link-menu-sm">Instagram</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="https://www.linkedin.com/in/mel-almanza-8869aa50/" target="_blank" class="link-menu-sm">Linkedin</a></p>
		</div>
	</div>
